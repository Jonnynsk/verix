...
export const metadata: Metadata = {
  title: "Политика конфиденциальности | ВЕРИКС",
  description:
    "Политика в отношении обработки персональных данных Сертификационного центра ВЕРИКС.",
};
    ...
    <main className={styles.privacy}>
      <div className={styles.privacy__inner}>
        <article className={styles.privacy__article}>
          ...
          <section className={styles.privacy__section} id="terms">
          ...
          <section className={styles.privacy__section} id="operator-rights">
            <h2 className={styles.privacy__heading}>
              3. Основные права и обязанности Оператора
            </h2>
            <h3 className={styles.privacy__subheading}>
          ...
          <section className={styles.privacy__section} id="subjects-rights">
            <h2 className={styles.privacy__heading}>
          ...
          <section className={styles.privacy__section} id="principles">
            <h2 className={styles.privacy__heading}>
          ...
          <section className={styles.privacy__section} id="goals">
            <h2 className={styles.privacy__heading}>
              6. Цели обработки персональных данных
            </h2>
            <ul className={styles.privacy__bullets}>
              <li>
                <strong>Цель обработки:</strong> предоставление доступа
                Пользователю к сервисам, информации и/или материалам,
                содержащимся на веб-сайте.
              </li>
              <li>
                <strong>Персональные данные:</strong> Обезличенные данные о
                посетителях (файлы cookie, IP-адреса, сведения об операционной
                системе и типе браузера).
              </li>
              <li>
                <strong>Правовые основания:</strong> Согласие субъекта
                персональных данных на их обработку.
              </li>
              <li>
                <strong>Виды обработки персональных данных:</strong> Сбор,
                запись, систематизация, накопление, хранение, уничтожение,
                обезличивание и передача (предоставление доступа) персональных
                данных.
              </li>
            </ul>

            <h3 className={styles.privacy__subheading}>
              6.1. Категории субъектов и категории персональных данных
            </h3>
            <p className={styles.privacy__text}>
            ...
            <ul className={styles.privacy__bullets}>
              ...
              <li>
                лица, обратившиеся к Оператору по телефону, электронной почте или
                через мессенджеры/социальные сети.
              </li>
            </ul>

            <p className={styles.privacy__text}>
              Категории персональных данных, которые могут обрабатываться
              Оператором:
            </p>
            <ul className={styles.privacy__bullets}>
              <li>
                <strong>Технические данные:</strong> IP-адрес, cookie, сведения
                об устройстве, операционной системе и браузере, данные о
                посещениях страниц (в том числе с использованием систем
                веб-аналитики).
              </li>
              <li>
                <strong>Контактные данные:</strong> номер телефона и/или адрес
                электронной почты, а также иная информация, которую субъект
                персональных данных добровольно сообщает при обращении к
                Оператору.
              </li>
            </ul>

            <h3 className={styles.privacy__subheading}>
              6.2. Сроки хранения и порядок уничтожения персональных данных
            </h3>
            <p className={styles.privacy__text}>
              Персональные данные обрабатываются и хранятся не дольше, чем это
              требуется целями обработки, если иной срок хранения не установлен
              законодательством РФ. По достижении целей обработки, при отзыве
              согласия (если отсутствуют иные законные основания для обработки),
              а также при выявлении неправомерной обработки персональные данные
              подлежат уничтожению или обезличиванию в установленном порядке.
            </p>
          </section>

          <section className={styles.privacy__section} id="conditions">
            <h2 className={styles.privacy__heading}>
          ...
          <section className={styles.privacy__section} id="procedure">
            <h2 className={styles.privacy__heading}>
            ...
            <ol className={styles.privacy__list}>
              ...
              <li>
                ...
                том числе сервисами веб-аналитики (ООО «ЯНДЕКС», Google LLC),
                хранится и обрабатывается указанными лицами (Операторами) в
                соответствии с их Пользовательским соглашением и Политикой
                конфиденциальности. Субъект персональных данных обязан
                самостоятельно ознакомиться с указанными документами. Оператор
          ...
          <section className={styles.privacy__section} id="cross-border">
            <h2 className={styles.privacy__heading}>
          ...
          <section className={styles.privacy__section} id="confidentiality">
            <h2 className={styles.privacy__heading}>
          ...
          <section className={styles.privacy__section} id="final">
            <h2 className={styles.privacy__heading}>
